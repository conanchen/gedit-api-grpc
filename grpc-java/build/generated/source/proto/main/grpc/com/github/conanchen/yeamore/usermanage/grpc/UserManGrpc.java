...
public final class UserManGrpc {
        ...
        if ((getAddMethod = UserManGrpc.getAddMethod) == null) {
          UserManGrpc.getAddMethod = getAddMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new UserManMethodDescriptorSupplier("Add"))
                  .build();
          }
        }
     }
        ...
        if ((getListMethod = UserManGrpc.getListMethod) == null) {
          UserManGrpc.getListMethod = getListMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new UserManMethodDescriptorSupplier("List"))
                  .build();
          }
        }
     }
      ...
      synchronized (UserManGrpc.class) {
        if ((getGetMethod = UserManGrpc.getGetMethod) == null) {
          UserManGrpc.getGetMethod = getGetMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.conanchen.yeamore.usermanage.grpc.UserResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new UserManMethodDescriptorSupplier("Get"))
                  .build();
          }
        }
     }
        ...
        if ((getUpsertMethod = UserManGrpc.getUpsertMethod) == null) {
          UserManGrpc.getUpsertMethod = getUpsertMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new UserManMethodDescriptorSupplier("Upsert"))
                  .build();
          }
        }
     }
        ...
        if ((getDeleteMethod = UserManGrpc.getDeleteMethod) == null) {
          UserManGrpc.getDeleteMethod = getDeleteMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new UserManMethodDescriptorSupplier("Delete"))
                  .build();
          }
        }
     }
  ...
  private static abstract class UserManBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoFileDescriptorSupplier, io.grpc.protobuf.ProtoServiceDescriptorSupplier {
    UserManBaseDescriptorSupplier() {}

    @java.lang.Override
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.github.conanchen.yeamore.usermanage.grpc.UserManProto.getDescriptor();
    }

    @java.lang.Override
    public com.google.protobuf.Descriptors.ServiceDescriptor getServiceDescriptor() {
      return getFileDescriptor().findServiceByName("UserMan");
    }
  }

  private static final class UserManFileDescriptorSupplier
      extends UserManBaseDescriptorSupplier {
    UserManFileDescriptorSupplier() {}
  }

  private static final class UserManMethodDescriptorSupplier
      extends UserManBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoMethodDescriptorSupplier {
    private final String methodName;

    UserManMethodDescriptorSupplier(String methodName) {
      ...
      synchronized (UserManGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new UserManFileDescriptorSupplier())
