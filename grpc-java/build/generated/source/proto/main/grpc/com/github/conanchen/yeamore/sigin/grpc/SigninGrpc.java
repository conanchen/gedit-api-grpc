...
public final class SigninGrpc {
        ...
        if ((getQQSigninMethod = SigninGrpc.getQQSigninMethod) == null) {
          SigninGrpc.getQQSigninMethod = getQQSigninMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new SigninMethodDescriptorSupplier("QQSignin"))
                  .build();
          }
        }
     }
      ...
      synchronized (SigninGrpc.class) {
        if ((getWXSigninMethod = SigninGrpc.getWXSigninMethod) == null) {
          SigninGrpc.getWXSigninMethod = getWXSigninMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.conanchen.yeamore.sigin.grpc.SigninResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new SigninMethodDescriptorSupplier("WXSignin"))
                  .build();
          }
        }
     }
      ...
      synchronized (SigninGrpc.class) {
        if ((getWBSigninMethod = SigninGrpc.getWBSigninMethod) == null) {
          SigninGrpc.getWBSigninMethod = getWBSigninMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.conanchen.yeamore.sigin.grpc.SigninResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new SigninMethodDescriptorSupplier("WBSignin"))
                  .build();
          }
        }
     }
      ...
      synchronized (SigninGrpc.class) {
        if ((getLocalSigninMethod = SigninGrpc.getLocalSigninMethod) == null) {
          SigninGrpc.getLocalSigninMethod = getLocalSigninMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.conanchen.yeamore.sigin.grpc.SigninResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new SigninMethodDescriptorSupplier("LocalSignin"))
                  .build();
          }
        }
     }
  ...
  private static abstract class SigninBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoFileDescriptorSupplier, io.grpc.protobuf.ProtoServiceDescriptorSupplier {
    SigninBaseDescriptorSupplier() {}

    @java.lang.Override
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.github.conanchen.yeamore.sigin.grpc.SigninProto.getDescriptor();
    }

    @java.lang.Override
    public com.google.protobuf.Descriptors.ServiceDescriptor getServiceDescriptor() {
      return getFileDescriptor().findServiceByName("Signin");
    }
  }

  private static final class SigninFileDescriptorSupplier
      extends SigninBaseDescriptorSupplier {
    SigninFileDescriptorSupplier() {}
  }

  private static final class SigninMethodDescriptorSupplier
      extends SigninBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoMethodDescriptorSupplier {
    private final String methodName;

    SigninMethodDescriptorSupplier(String methodName) {
      ...
      synchronized (SigninGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new SigninFileDescriptorSupplier())
